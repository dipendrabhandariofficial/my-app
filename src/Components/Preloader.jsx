...
const Preloader = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-r from-sky-600 via-blue-500 to-indigo-600">
      ...
      >
        {["D", "I", "P", "E", "N", "D", "R", "A"].map((letter, index) => (
          <motion.span
            key={index}
            className="text-[80px] font-bold text-white drop-shadow-lg"
            animate={{
              scale: [1, 1.2, 1],
